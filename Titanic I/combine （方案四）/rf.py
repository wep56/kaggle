...
def Titanic_rf():
    ...
    train_df,test_df=dataProcess.getDataSets(binary=True,bins=True,scaled=True,interactive_auto=True)
    ...
    rand_search=GridSearchCV(forest,params_test,n_jobs=-1,cv=4)
    rand_search.fit(X,y)
    ...
    params_score={"n_estimators":10000,"max_features":sqrtfeat,"max_depth":5,"min_samples_split":minsampsplit,"random_state": 1234567890}
    params=params_score
    '''
    #============================================================================================
    '''
